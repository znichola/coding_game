...
const LIFETIME = 3;  // turns a connection is assumed to survive (inking, foe shortcuts): earlier completion is worth more
...
const SUNK_W = 1;     // penalty per paint point of my tracks that inking would wash away
